...
namespace Application.Infrastructure.TcpClient
{
    public class AsyncTcpClient
    {
        ...
        public AsyncTcpClient(string _ip, int _port)
        {
        ...
        public void Connect()
        {
            ...
            catch (Exception e)
            {
                ...
                throw new Exception("Socket Connection Falied. Message : " + e.ToString());
            }
        }
            ...
            if (IsConnected())
            {
                try
                {
                    ...
                    if (nBytesRec > 0)
                    {
                        ...
                        OnDataRecievedEvent(Encoding.UTF8.GetString(readerBuffer, 0, nBytesRec));
